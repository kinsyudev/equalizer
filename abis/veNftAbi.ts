export const veNftAbi = [
    [
        ...
        { inputs: [], name: 'MAX_HOLDINGS', outputs: [{ internalType: 'uint8', name: '', type: 'uint8' }], stateMutability: 'view', type: 'function' },
        ...
        { inputs: [], name: 'delegationsAllowed', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
        {
            inputs: [
                { internalType: 'uint256', name: '_tokenId', type: 'uint256' },
                { internalType: 'uint256', name: '_value', type: 'uint256' },
        ...
        { inputs: [], name: 'maxLockAll', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        { inputs: [{ internalType: 'uint256[]', name: '_ids', type: 'uint256[]' }], name: 'maxLockMultiple', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
            inputs: [
        ...
        { inputs: [], name: 'oldVoter', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
        {
            inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }],
            name: 'ownerOf',
            outputs: [{ internalType: 'address', name: '', type: 'address' }],
        ...
        { inputs: [{ internalType: 'bool', name: '_a', type: 'bool' }], name: 'setDelegationsAllowed', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        { inputs: [{ internalType: 'uint8', name: '_m', type: 'uint8' }], name: 'setMaxHoldings', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        { inputs: [{ internalType: 'address', name: '_v', type: 'address' }], name: 'setNewVoter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        { inputs: [{ internalType: 'address', name: '_ov', type: 'address' }], name: 'setOldVoter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        ...
        { inputs: [], name: 'totalTokensBurned', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
        { inputs: [], name: 'totalTokensMinted', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
        {
            inputs: [
                { internalType: 'address', name: '_from', type: 'address' },
                { internalType: 'address', name: '_to', type: 'address' },
