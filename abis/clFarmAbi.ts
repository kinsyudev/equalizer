export const clFarmAbi = [
    {
        inputs: [
            { internalType: 'address', name: '_stakingToken', type: 'address' },
            { internalType: 'address', name: '_tg', type: 'address' },
            { internalType: 'bytes', name: '_tf', type: 'bytes' },
        ],
        payable: false,
    ...
    },
    {
        ...
        inputs: [
            ...
            { internalType: 'bytes', name: '_TvlPriceFeed', type: 'bytes' },
        ],
        name: 'addReward',
        outputs: [],
        payable: false,
    ...
    {
        constant: false,
        inputs: [{ internalType: 'uint256', name: '_f', type: 'uint256' }],
        name: 'setFee',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
    ...
    {
        constant: false,
        inputs: [{ internalType: 'address', name: '_tg', type: 'address' }],
        name: 'setTvlGuru',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
